...
workbook = xlrd.open_workbook(r'C:\Users\samuel\Desktop\robos\excel.xls')
...
driver = webdriver.Chrome(r'C:\Users\samuel\Desktop\robos\chromedriver')
...
for curr_row in range(0, rows):
    ...
    texto = "Domínio %s %s\n" % (x, driver.find_element(
        By.XPATH, '//*[@id="app"]/main/section/div[2]/div/p/span/strong').text)
    arq.write(texto)
